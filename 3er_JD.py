...
dtransicion = pd.read_csv("transicion.csv", encoding="unicode escape")
...
for p in deprog_educ:
    ...
    #  Indice de titulación vs egresados solo se cálcula para los PE con egresados
    ...
    idx_tmp = pd.DataFrame({
        ...
        "PLAN": etemp["PLAN"].max(),
        "DIVISION": etemp["DIVISION"].max(),
        "EGRESADOS": matr_t_pe(etemp),
        "TITULADOS": matr_t_pe(ttemp),
        "IND_TIT": indice(matr_t_pe(etemp), matr_t_pe(ttemp))}, index = [len(idx_titulacion)])
    if matr_egt_pe(etemp)!=0:
        idx_titulacion = pd.concat([idx_titulacion, idx_tmp])
...
itemp_actual = dinscrito[dinscrito["MODALIDAD"]=="SEMESTRE"]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=1]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=3]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=5]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=7]
itemp_anterior = dtransicion[dtransicion["MODALIDAD"]=="SEMESTRE"]
itemp_anterior = itemp_anterior[itemp_anterior["NIVEL"]=="LICENCIATURA"]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=2]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=4]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=6]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=8]
tr_sm_l = pd.concat([itemp_actual, itemp_anterior])
tr_sm_l = tr_sm_l.groupby(["MODALIDAD", "NIVEL", "SISTEMA","PROG_EDUC","CICLO","GRADO"])["MATRICULA"].aggregate("count")
tr_sm_l = pd.DataFrame(tr_sm_l)
tr_sm_l = tr_sm_l.pivot_table(
    values="MATRICULA",
    index=["MODALIDAD", "NIVEL", "SISTEMA", "PROG_EDUC"],
    columns=["CICLO","GRADO"],fill_value=0).sort_values(
...
itemp_actual = dinscrito[dinscrito["MODALIDAD"]=="CUATRIMESTRE"]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=1]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=3]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=5]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=7]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=9]
itemp_actual = itemp_actual[itemp_actual["GRADO"]!=11]
itemp_anterior = dtransicion[dtransicion["MODALIDAD"]=="CUATRIMESTRE"]
itemp_anterior = itemp_anterior[itemp_anterior["NIVEL"]=="LICENCIATURA"]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=2]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=4]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=6]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=8]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=10]
itemp_anterior = itemp_anterior[itemp_anterior["GRADO"]!=12]
tr_cm_l = pd.concat([itemp_actual, itemp_anterior])
tr_cm_l = tr_cm_l.groupby(["MODALIDAD", "NIVEL", "SISTEMA","PROG_EDUC","CICLO","GRADO"])["MATRICULA"].aggregate("count")
tr_cm_l = pd.DataFrame(tr_cm_l)
tr_cm_l = tr_cm_l.pivot_table(
    values="MATRICULA",
    index=["MODALIDAD", "NIVEL", "SISTEMA", "PROG_EDUC"],
    columns=["CICLO","GRADO"],fill_value=0).sort_values(
    by=["MODALIDAD", "NIVEL", "SISTEMA", "PROG_EDUC"],
    ascending=[False, True, True, True])
#  Creación de las tablas por edades para el 911 por P.E.
#  Primero hay que
idx_edades = dinscrito.groupby(["MODALIDAD", "NIVEL", "SISTEMA","PROG_EDUC","EDAD"])["MATRICULA"].aggregate("count")
idx_edades = pd.DataFrame(idx_edades)
idx_edades = idx_edades.pivot_table(
    values="MATRICULA",
    index=["MODALIDAD", "NIVEL", "SISTEMA", "PROG_EDUC"],
    columns=["EDAD"],fill_value=0).sort_values(
    by=["MODALIDAD", "NIVEL", "SISTEMA", "PROG_EDUC"],
    ascending=[False, True, True, True])
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3MESem.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        #  xlim = (0, 10),  #  Activar si la gráfica es de menos de 5 datos
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3MSS.png",dpi=300,bbox_inches='tight')
g= idx_m[idx_m["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="",
        ylabel="Matrícula",
        fontsize=7).get_figure().savefig("2022T3MSC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        xlim = (0, 5),  #  Activar si la gráfica es de pocos datos
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3MP.png",dpi=300,bbox_inches='tight')
#  TURNO
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3MTES.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3MTSS.png",dpi=300,bbox_inches='tight')
g= idx_mturno[idx_mturno["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3MTSC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 5),  #  Activar si la gráfica es de pocos datos
        ylabel = "",
        fontsize=7).get_figure().savefig("2022T3MTP.png",dpi=300,bbox_inches='tight')
#  NUEVO INGRESO
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3NIES.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3NISS.png",dpi=300,bbox_inches='tight')
g= idx_ni[idx_ni["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        xlim = (0, 30),  #  Activar si la gráfica es de menos de 5 datos
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3NISC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3NIP.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ADES.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ADSS.png",dpi=300,bbox_inches='tight')
g= idx_atn_dmda[idx_atn_dmda["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ADSC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ADP.png",dpi=300,bbox_inches='tight')
#  APROVECHAMIENTO
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3AES.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ASS.png",dpi=300,bbox_inches='tight')
g= idx_maprovechamiento[idx_maprovechamiento["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ASC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
       fontsize=7).get_figure().savefig("2022T3AP.png",dpi=300,bbox_inches='tight')
#  REPROBACION
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3RES.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
       ...
       color = ["hotpink", "deepskyblue"],
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3RSS.png",dpi=300,bbox_inches='tight')
g= idx_mreprobacion[idx_mreprobacion["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3RSC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3RP.png",dpi=300,bbox_inches='tight')
#  DESERCION
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 100),
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3DES.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3DSS.png",dpi=300,bbox_inches='tight')
 g= idx_mdesercion[idx_mdesercion["SISTEMA"] == "SEMIESCOLARIZADO"]
 g = g[g["NIVEL"] == "LICENCIATURA"]
 g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3DSC.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3DP.png",dpi=300,bbox_inches='tight')
 #  ABANDONO
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3ABES.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3ABSS.png",dpi=300,bbox_inches='tight')
 g= idx_mabandono[idx_mabandono["SISTEMA"] == "SEMIESCOLARIZADO"]
 g = g[g["NIVEL"] == "LICENCIATURA"]
 g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3ABSC.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3ABP.png",dpi=300,bbox_inches='tight')
 #  BAJAS TEMPORALES
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3BTES.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3BTSS.png",dpi=300,bbox_inches='tight')
 g= idx_bajatemp[idx_bajatemp["SISTEMA"] == "SEMIESCOLARIZADO"]
 g = g[g["NIVEL"] == "LICENCIATURA"]
 g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3BTSC.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3BTP.png",dpi=300,bbox_inches='tight')
 #  BAJAS DEFINITIVA
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3BDES.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         ylim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3BDSS.png",dpi=300,bbox_inches='tight')
 g= idx_bajadef[idx_bajadef["SISTEMA"] == "SEMIESCOLARIZADO"]
 g = g[g["NIVEL"] == "LICENCIATURA"]
 g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3BDSC.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlim = (0, 100),
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3BDP.png",dpi=300,bbox_inches='tight')
 #  EGRESADOS
 ...
 if len(g)!=0:
     g.plot(
         ...
         xlabel="Matrícula",
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3EGES.png",dpi=300,bbox_inches='tight')
 ...
 if len(g)!=0:
     g.plot(
         ...
         fontsize=7).get_figure().savefig("2022T3EGSS.png",dpi=300,bbox_inches='tight')
 g= idx_egresado[idx_egresado["SISTEMA"] == "SEMIESCOLARIZADO"]
 g = g[g["NIVEL"] == "LICENCIATURA"]
 g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
 if len(g)!=0:
     g.plot(
         ...
         xlabel="Matrícula",
         ylabel="",
         fontsize=7).get_figure().savefig("2022T3EGSC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 10),  #  Activar si la gráfica es de menos de 5 datos
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3EGP.png",dpi=300,bbox_inches='tight')
#  INDICE TITULACION
g = idx_titulacion [idx_titulacion["SISTEMA"] == "ESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "SEMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        kind="barh",
        figsize=(8, 5),
        title="Indice Titulación Escolarizado Semestral",
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ITES.png",dpi=300,bbox_inches='tight')
g = idx_titulacion[idx_titulacion["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "SEMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        kind="barh",
        figsize=(8, 5),
        title="Indice Titulación Semiescolarizado Semestral",
        xlabel="Matrícula",
        xlim = (0, 10),  #  Activar si la gráfica es de menos de 5 datos
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ITSS.png",dpi=300,bbox_inches='tight')
g= idx_titulacion[idx_titulacion["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        kind="barh",
        figsize=(8, 5),
        title="Indice Titulación Semiescolarizado Cuatrimestral",
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ITSC.png",dpi=300,bbox_inches='tight')
g = idx_titulacion[idx_titulacion["NIVEL"] == "MAESTRIA"]  #  Se grafican juntos por ser pocos
if len(g)!=0:
    g.plot(
        x="PLAN",
        y=["EGRESADOS", "TITULADOS"],
        ...
        kind="barh",
        figsize=(8, 5),
        title="Indice de Titulación Posgrado",
        xlabel="Matrícula",
        xlim = (0, 5),  #  Activar si la gráfica es de menos de 5 datos
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ITP.png",dpi=300,bbox_inches='tight')
#  TITULADOS
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3TES.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 5),  #  Activar si la gráfica es de menos de 5 datos
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3TSS.png",dpi=300,bbox_inches='tight')
g= idx_titulado[idx_titulado["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3TSC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlim = (0, 10),  #  Activar si la gráfica es de menos de 5 datos
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3TP.png",dpi=300,bbox_inches='tight')
#  EFICIENCIA TERMINAL
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ETES.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ETSS.png",dpi=300,bbox_inches='tight')
g= idx_cohorte[idx_cohorte["SISTEMA"] == "SEMIESCOLARIZADO"]
g = g[g["NIVEL"] == "LICENCIATURA"]
g = g[g["MODALIDAD"] == "CUATRIMESTRE"]
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ETSC.png",dpi=300,bbox_inches='tight')
...
if len(g)!=0:
    g.plot(
        ...
        xlabel="Matrícula",
        ylabel="",
        fontsize=7).get_figure().savefig("2022T3ETP.png",dpi=300,bbox_inches='tight')
...
idx_titulacion.drop(["DIVISION", "PLAN"], axis="columns", inplace=True)
...
writer = pd.ExcelWriter("2022T3_JD.xlsx")
...
tr_sm_l.to_excel(writer, sheet_name = "trans_lic_sem")
tr_sm_m.to_excel(writer, sheet_name = "trans_mtria_sem")
tr_cm_l.to_excel(writer, sheet_name = "trans_lic_cuatrim")
tr_cm_m.to_excel(writer, sheet_name = "trans_mtria_cuatrim")
...
idx_titulacion.to_excel(writer, sheet_name = "indice_titulacion")
